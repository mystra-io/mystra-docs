...
- ### More points 
Each ticket has an algorithmically assigned number of <a href="https://docs.casperarmy.org/docs/point-system/3.8-Tickets">points</a>. Increase your points by buying more tickets. You can buy a maximum of 100 tickets per wallet. However, only 10 tickets per wallet will be considered for DAO voting.
...
CasperArmy tickets can be purchased by using the following:
See <a href="https://docs.casperarmy.org/docs/PRODUCTS%20AND%20SERVICES/2.11-networks-and-payments">Networks and Payments</a>.
