...
Mystra API:</br>
  ...
  Mainet:  <code>comming soon</code></br></br>
...
Casper Network Event Store (Parser) API:</br>
  ...
  Mainet:  <code>https://api.casper.mystra.io/swagger</code></br>
...
Requests that potentially may return an unlimited number of items are paginated. In addition to the endpoint-specific parameters, they accept the following pagination parameters:
 <table>
  ...
  <tr>
    ...
    <td>int</td>
    <td>1..n</td>
    <td>Nnumber of the previous available page</td>
  </tr>
  <tr>
    <td>next_page</td>
    <td>int</td>
    <td>1..n</td>
    <td>Nnumber of next available page</td>
  </tr>
</table>
