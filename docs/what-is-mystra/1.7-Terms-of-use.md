...
1.21.“Purchase Price” shall mean the price the Participant shall pay in consideration for purchasing the Premium Pass or any Project(s) token.
...
1.The Project is a non-profit organization proceeding to the private and public minting of Premium Pass (Non-fungible tokens) for the purpose of financing its  activity. The Project is not a bank, a security firm, an asset manager, a portfolio manager or an investment advisor. The Project is not a financial institution or a financial service provider.
